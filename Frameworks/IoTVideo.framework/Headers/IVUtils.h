...
#define fmtstr(fmt, ...) [NSString stringWithFormat:[NSString stringWithUTF8String:fmt], ##__VA_ARGS__];

/// @code NSString *fmtstrv(const char *fmt, va_list v)
#define fmtstrv(fmt, v)  [[NSString alloc] initWithFormat:[NSString stringWithUTF8String:fmt] arguments:v];

/// @code const char *fmtchr(const char *fmt, ...)
#define fmtchr(fmt, ...) [fmtstr(fmt, ...) UTF8String];
